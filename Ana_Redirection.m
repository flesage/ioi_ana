function Ana_Redirection(FolderName, SpatialFilterData, SpatialFilterSize, m_OutStream)
...
if( ~isempty(FileList) )
    ...
    Ana_Speckle(FolderName, SpatialFilterData, SpatialFilterSize, m_OutStream);
else
