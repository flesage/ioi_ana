function ConvertToTiff(FolderPath, varargin)
...
%
% Inputs:
%   FolderPath(str): Path to the folder where the .dat files are located.
...
if nargin > 1
    datFileName = varargin{1};
    if ~iscell(datFileName)
