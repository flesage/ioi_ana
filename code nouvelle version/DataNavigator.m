...
%%% area finder
h.ui.dispFtresh = uipanel('Parent', h.ui.fig, 'Title','find treshold','FontSize',12,...
...
%%%%%%%%%%%%%%%
    ...
    function MoveEventsDisp(~,~,~)
        ...
        if(h.flags.SlaveStim)
            if(h.data.ssdiff >= 0)
                h.ui.EventsDispPan.dispAx.zeroline = line(h.ui.EventsDispPan.Ax,[-h.data.MasterStim.PreStimLength  -h.data.MasterStim.PreStimLength], [min(d) max(d)], 'Color', 'g', 'LineStyle','--');
                h.ui.EventsDispPan.dispAx.Masterstimline= line(h.ui.EventsDispPan.Ax,[h.data.MasterStim.StimLength-h.data.MasterStim.PreStimLength h.data.MasterStim.StimLength-h.data.MasterStim.PreStimLength],[min(d) max(d)],'Color', 'r', 'LineStyle','--');
                h.ui.EventsDispPan.dispAx.Slavestimline= line(h.ui.EventsDispPan.Ax, [h.data.ssdiff+h.data.SlaveStim.StimLength-h.data.SlaveStim.PreStimLength h.data.ssdiff+h.data.SlaveStim.StimLength-h.data.SlaveStim.PreStimLength],[min(d) max(d)],'Color', 'm', 'LineStyle',':');
                 h.ui.EventsDispPan.dispAx.Slavezeroline = line(h.ui.EventsDispPan.Ax,[h.data.ssdiff-h.data.SlaveStim.PreStimLength h.data.ssdiff-h.data.SlaveStim.PreStimLength],[min(d) max(d)],'Color', 'b', 'LineStyle',':');
            else
                h.ui.EventsDispPan.dispAx.zeroline = line(h.ui.EventsDispPan.Ax,[abs(h.data.ssdiff)-h.data.MasterStim.PreStimLength abs(h.data.ssdiff)-h.data.MasterStim.PreStimLength],[min(d) max(d)],'Color', 'g', 'LineStyle','--');
                h.ui.EventsDispPan.dispAx.Masterstimline= line(h.ui.EventsDispPan.Ax,...
                    [(h.data.MasterStim.StimLength+abs(h.data.ssdiff)-h.data.MasterStim.PreStimLength) (h.data.MasterStim.StimLength+abs(h.data.ssdiff)-h.data.MasterStim.PreStimLength)],[min(d) max(d)],'Color', 'r', 'LineStyle','--');
                h.ui.EventsDispPan.dispAx.Slavestimline= line(h.ui.EventsDispPan.Ax,[h.data.SlaveStim.StimLength-h.data.SlaveStim.PreStimLength h.data.SlaveStim.StimLength-h.data.SlaveStim.PreStimLength],[min(d) max(d)],'Color', 'm', 'LineStyle',':');
                ...
                h.ui.EventsDispPan.dispAx.zeroline = line(h.ui.EventsDispPan.Ax, [-h.data.MasterStim.PreStimLength -h.data.MasterStim.PreStimLength], [min(d) max(d)],...
                    'Color', 'g', 'LineStyle','--');
                h.ui.EventsDispPan.dispAx.Masterstimline= line(h.ui.EventsDispPan.Ax,[h.data.MasterStim.StimLength-h.data.MasterStim.PreStimLength h.data.MasterStim.StimLength-h.data.MasterStim.PreStimLength],[min(d) max(d)],'Color', 'r', 'LineStyle','--');
        end
        if( mean(d) > 0.5 )
    ...
    function MeanRecalculation()
        ...
        if(h.flags.SlaveStim)
            if(h.data.ssdiff >= 0)
                h.ui.EventsMeanPan.dispAx.zeroline= line(h.ui.EventsMeanPan.Ax, [-h.data.MasterStim.PreStimLength -h.data.MasterStim.PreStimLength],...
                 [min(d) max(d)],'Color', 'g', 'LineStyle','--');
                h.ui.EventsMeanPan.dispAx.Masterstimline = line(h.ui.EventsMeanPan.Ax, [h.data.MasterStim.StimLength-h.data.MasterStim.PreStimLength h.data.MasterStim.StimLength-h.data.MasterStim.PreStimLength],...
                    [min(d) max(d)], 'Color', 'r', 'LineStyle','--');
                h.ui.EventsMeanPan.dispAx.Slavestimline = line(h.ui.EventsMeanPan.Ax, [(h.data.SlaveStim.StimLength+h.data.ssdiff-h.data.SlaveStim.PreStimLength) (h.data.SlaveStim.StimLength+h.data.ssdiff-h.data.SlaveStim.PreStimLength)],...
                    [min(d) max(d)], 'Color', 'm', 'LineStyle',':');
                 h.ui.EventsMeanPan.dispAx.Slavezeroline = line(h.ui.EventsMeanPan.Ax, [h.data.ssdiff-h.data.SlaveStim.PreStimLength h.data.ssdiff-h.data.SlaveStim.PreStimLength],...
                    [min(d) max(d)],'Color', 'b', 'LineStyle',':');
            else
                 h.ui.EventsMeanPan.dispAx.zeroline= line(h.ui.EventsMeanPan.Ax, [(abs(h.data.ssdiff))-h.data.MasterStim.PreStimLength (abs(h.data.ssdiff))-h.data.MasterStim.PreStimLength],...
                    [min(d) max(d)],'Color', 'g', 'LineStyle','--');
                 h.ui.EventsMeanPan.dispAx.Masterstimline = line(h.ui.EventsMeanPan.Ax, [h.data.MasterStim.StimLength+abs(h.data.ssdiff)-h.data.MasterStim.PreStimLength h.data.MasterStim.StimLength+abs(h.data.ssdiff)-h.data.MasterStim.PreStimLength],...
                    [min(d) max(d)], 'Color', 'r', 'LineStyle','--');
...
%         RefreshLoop('ROIs');
    ...
    function findAreas(~,~,~)
        ...
        temp_dat = memmapfile([h.paths.FolderName filesep 'HbO.dat'], 'Format', 'single');
        dat_set = reshape(temp_dat.Data,size(h.data.Map,1),size(h.data.Map,2),[]);
        dat_set_f = imfilter(dat_set, fspecial('gaussian',5,3),'same','symmetric');
        ...
        se = strel('disk',10);
        roi_tresh1 = imclose(dat_set_f(:,:,indx_t1).*h.data.ROI.brainmask > tresh1*max_val/100,se);
        roi_tresh2 = imclose(dat_set_f(:,:,indx_t1).*h.data.ROI.brainmask > tresh2*max_val/100,se);
        roi_tresh3 = imclose(dat_set_f(:,:,indx_t1).*h.data.ROI.brainmask > tresh3*max_val/100,se);
        ...
        axis(brain_ax,'off');
        tresh_cmap = load('treshs_map.mat');
        tresh_ax = axes('Parent',fig,'Position',[0.05 0.05 0.75 0.92]);
        imagesc(tresh_ax,total_roi.*roi_tresh3,'AlphaData',total_roi.*0.25);
        colormap(tresh_ax,cat(1,[0 0 0],tresh_cmap.treshs_map));
        axis(tresh_ax,'off');
    end
